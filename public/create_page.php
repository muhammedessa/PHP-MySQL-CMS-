...
<a href="create_page.php?menu=<?php echo   mysqli_real_escape_string($conn,$row["id"]);   ?> "><h4><?php echo   mysqli_real_escape_string($conn,$row["item_name"]) ;  ?></h4> </a>
...
<div class="col-sm-10">
 ...
 <div class="panel panel-danger">
  ...
  <form method="post" action="create_page_submit.php">
